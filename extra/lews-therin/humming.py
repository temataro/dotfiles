...
QUOTE_DIR = (
    "/home/tem/code/github.com/temataro/dotfiles/extra/lews-therin/all-quotes.txt"
)
...
def main():
    ...
    err = sp.run("which glow".split(), stdout=sp.DEVNULL, stderr=sp.DEVNULL).returncode
    if err:
        print(
            "You don't currently have glow on your system. Install from your"
    ...
    if random.randint(0, 100) < HIT_PROBABILITY:
        ...
        sp.run("cat /tmp/tmp-quote.md".split())
